...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="s1_1"><img src="slide1/s1_1.png"/></div><div class="s1_2"><img src="slide1/s1_2.png"/></div><div class="s1_3"><img src="slide1/s1_3.png"/></div><div class="s1_4 pulseUp" onclick="startAnime();"><img src="slide1/s1_4.png"/></div><div class="s1_5"><img src="slide1/s1_5.png"/></div>';
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1024" height="768" alt=""></div><div class="s2_1"><img src="slide2/2.jpg" width="1024" height="768" alt=""/></div><div class="s2_pop1" onclick="s2_pop1()"></div><div class="s2_2"><img src="slide2/3.jpg" width="1024" height="768" alt=""/></div><div class="s2_pop2" onclick="s2_pop2()"></div><div class="s2_3"><img src="slide2/4.jpg" width="1024" height="768" alt=""/></div><div class="s2_pop3" onclick="s2_pop3()"></div><div class="s2_4"><img src="slide2/5.jpg" width="1024" height="768" alt=""/></div><div class="s2_pop4" onclick="s2_pop4()"></div><div class="s2_c1ose1" onclick="s2_close1()"></div>';
	break;
	case 3:
